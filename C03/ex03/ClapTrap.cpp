...
ClapTrap::ClapTrap(std::string name) {
	cout << "ClapTrap 1 parameter constructor called." << std::endl;
	this->name = name;
	this->health = 10;
	this->energy = 10;
	this->damage = 0;
...
ClapTrap &ClapTrap::operator=(const ClapTrap &cl) {
	cout << "ClapTrap operator overloading called." << std::endl;
...
ClapTrap::ClapTrap(std::string name, unsigned int health, unsigned int energy, unsigned int damage) {
	...
	this->energy = energy;
	this->damage = damage;
	cout << "ClapTrap 4 parameter constructor called." << std::endl;
}
